...
function loadDataAlat() {
    ...
    if (data) {
        ...
        const dataAwal = [
            { id: 1, kode: "A001", nama: "Tenda Dome", kategori: "Tenda", stok: 10, harga: 100000, foto: "image/tenda.jpg" },
            { id: 2, kode: "A002", nama: "Carrier 60L", kategori: "Carrier", stok: 8, harga: 80000, foto: "image/Carrier Bag 60L.jpg" },
            { id: 3, kode: "A003", nama: "Sleeping Bag", kategori: "Sleeping", stok: 7, harga: 50000, foto: "image/SleepingBag.jpg" },
            { id: 4, kode: "A004", nama: "Kompor Portable", kategori: "Kompor", stok: 5, harga: 40000, foto: "image/Kompor.jpg" },
            { id: 5, kode: "A005", nama: "Matras", kategori: "Aksesoris", stok: 3, harga: 30000, foto: "image/Matras.jpg" }  // ← Perbaiki ini
        ];
